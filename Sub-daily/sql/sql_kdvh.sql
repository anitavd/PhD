spool /home/anitavd/PhD/Sub-daily/data/tipping/max10/11620_hourly_AM10.txt
...
from t_adata t1, v_st_info t2 where t1.stnr=t2.stnr and rr_1 is not null and t1.stnr in (11620) ) where r<=10) 
order by stnr, year;
